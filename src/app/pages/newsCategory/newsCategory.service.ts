...
export class NewsCategoryService {
  newsCategoryApi = environment.apiUrl + "/NewsCategory/"
  httpOptions
  ...
  getNewsCategories(){
    return this.http.get(`${this.newsCategoryApi}GetNewsCategories`,this.httpOptions).pipe()
  }
  getNewsSubCategories(id:number){
    return this.http.get(`${this.newsCategoryApi}GetNewsSubCategories?categoryId=${id}`,this.httpOptions)
  }
}
