...
import {
  ...
  IPermissionModel,
  PermissionService,
} from 'src/app/_fake/services/permission.service';
  ...
  implements OnInit, AfterViewInit, OnDestroy
{
  ...
  ngOnInit(): void {
    this.datatableConfig = {
      ...
      ajax: (
        ...
        callback: (arg0: DataTablesResponse) => void
      ) => {
        this.apiService
      ...
      columns: [
        ...
        },
        {
          title: 'Assigned To',
          data: null,
          render: function (data: { roles: any[] }, type: any, row: any) {
        ...
        },
        {
          title: 'Created Date',
          data: 'created_at',
          render: function (data: moment.MomentInput) {
  ...
  onSubmit(event: Event, myForm: NgForm) {
    ...
    const updateFn = () => {
      this.apiService
        .updatePermission(this.permissionModel.id, this.permissionModel)
        .subscribe({
          next: () => {
